...
export default function DashboardClient({ currentUser }: DashboardClientProps) {
  ...
  const [heroForm, setHeroForm] = useState<HeroConfig>({
    ...
    subheadline: "Artificial Quotient turns AI software into step-by-step workflow tutorials for 10K+ subscribers and 70K+ monthly viewers who create with AI tools every day.",
