  ...
  return (
    <div className="w-full py-32 px-4 bg-brand-bg dark:bg-zinc-950 min-h-screen flex items-center justify-center transition-colors">
      <div className="max-w-md w-full text-center">
        <div className="w-20 h-20 bg-brand-card dark:bg-zinc-900 border border-brand-border dark:border-zinc-800 rounded-3xl flex items-center justify-center text-4xl mx-auto mb-6 shadow-md">
          🐼
        </div>
