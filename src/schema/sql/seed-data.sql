...
VALUES 
  (
    ...
    '[{"id":"geo-1","name":"USA","percent":"10.7%"},{"id":"geo-2","name":"England","percent":"13.5%"},{"id":"geo-3","name":"India","percent":"21.8%"},{"id":"geo-4","name":"Germany","percent":"9.4%"}]', 
...
VALUES 
  ...
  (
    ...
    'EasyPeasy',
    'Dedicated Video',
    'Our goal was to showcase EasyPeasy\'s powerful AI workflow automation capabilities, driving high-intent signups and demonstrating real-world productivity use cases.',
    'Caveat',
    'Signups Generated',
    '680+',
    'Est. ROI Multiplier',
    '3.8x',
    'Goal: Show content creators, marketers, and power users how to utilize EasyPeasy to automate complex tasks, analyze documents, and construct custom AI tools effortlessly.',
    'Videos Made:\n1. EasyPeasy Tutorial: Build Custom AI Workflows & Automate Tasks\n2. Tracked Pinned Comment Link & Workflow Blueprint Download',
...
VALUES 
  ...
  (
    '3', 
    'How To Create Viral AI Cat Videos For FREE! (Meow Meow Cat Story Video Tutorial)', 
    '184.0k', 
    '6.5k+', 
    'Dedicated Video', 
    '🐱', 
