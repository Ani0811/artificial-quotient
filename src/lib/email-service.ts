...
export async function send2FACodeEmail(toEmail: string, code: string) {
  ...
  const mailOptions = {
    from: `"Artificial Quotient Security" <${process.env.SMTP_USER}>`,
    to: toEmail,
    subject: `[${code}] Your 2-Step Verification Code`,
    attachments: [
      {
        filename: "logo.jpeg",
        path: logoPath,
                ...
                <tr>
                  <td style="padding: 32px 32px 24px 32px; text-align: center;">
                    <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center">
                          <img src="cid:aqlogo@artificialquotient" alt="Artificial Quotient Logo" style="width: 56px; height: 56px; border-radius: 14px; margin-bottom: 14px; border: 1px solid #374151; display: block;" />
