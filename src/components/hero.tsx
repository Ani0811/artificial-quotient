...
export default function Hero() {
  return (
    <section className="w-full pt-16 pb-10 sm:pt-24 sm:pb-16 px-4 relative overflow-hidden transition-colors">
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col gap-5 sm:gap-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full bg-brand-card dark:bg-zinc-900/90 border border-brand-border dark:border-emerald-500/20 shadow-sm w-fit">
            <span className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-emerald-500 animate-pulse"></span>
            <span className="text-[10px] sm:text-xs font-semibold text-brand-muted dark:text-emerald-400 uppercase tracking-wider">Open for Q3 Sponsorships</span>
          </div>
          
          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-brand-text dark:text-white text-balance">
          ...
          <p className="text-base sm:text-lg text-brand-muted dark:text-zinc-300 max-w-xl font-body leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
            <a 
              ...
              target="_blank" 
              rel="noreferrer" 
              className="bg-emerald-500 hover:bg-emerald-600 text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl font-bold text-base sm:text-lg text-center transition-all shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 hover:-translate-y-0.5 active:translate-y-0"
            >
              Sponsor the Channel
            </a>
            <Link href="/#case-studies" className="bg-brand-card dark:bg-zinc-900/90 hover:bg-gray-50 dark:hover:bg-zinc-800 text-brand-text dark:text-white border border-brand-border dark:border-zinc-800 px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl font-bold text-base sm:text-lg text-center transition-all shadow-sm hover:-translate-y-0.5">
              View Case Studies
            </Link>
          </div>
        </div>
