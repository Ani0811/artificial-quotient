    ...
    <section className="w-full pt-10 pb-8 sm:pt-20 sm:pb-14 px-4 relative overflow-hidden transition-colors">
      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-6 lg:gap-12 items-center relative z-10">
        ...
        <div className="relative group">
          ...
          <div className="bg-zinc-950/95 dark:bg-zinc-950/90 backdrop-blur-2xl rounded-3xl p-4 sm:p-6 shadow-2xl text-white transform md:rotate-2 group-hover:rotate-0 transition-all duration-500 relative z-10 border border-zinc-800/80 group-hover:border-emerald-500/40 overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-5 gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h3 className="font-heading font-extrabold text-sm sm:text-lg tracking-tight text-white truncate">Artificial Quotient</h3>
              ...
              <a
                ...
                className="bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-600 text-white text-[10px] sm:text-xs font-bold px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl uppercase tracking-wider transition-all hover:scale-105 active:scale-95 flex items-center gap-1 shadow-md shadow-red-600/30 cursor-pointer shrink-0"
              >
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div className="bg-zinc-900/80 rounded-2xl p-3 sm:p-4 border border-zinc-800/80 transition-all hover:border-emerald-500/30 hover:bg-zinc-900">
                <p className="text-zinc-400 text-[10px] sm:text-xs mb-1 font-medium flex items-center gap-1.5">
                  <Users className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-emerald-400" /> Subscribers
                </p>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-xl sm:text-3xl font-heading font-extrabold text-white">10.1k</span>
                  <span className="text-[10px] sm:text-xs font-bold text-emerald-400 flex items-center gap-0.5">
                    <TrendingUp className="w-3 h-3" /> Active
                  </span>
                </div>
              </div>

              <div className="bg-zinc-900/80 rounded-2xl p-3 sm:p-4 border border-zinc-800/80 transition-all hover:border-cyan-500/30 hover:bg-zinc-900">
                <p className="text-zinc-400 text-[10px] sm:text-xs mb-1 font-medium flex items-center gap-1.5">
                  <Play className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-cyan-400" /> Monthly Views
                </p>
                <div className="flex items-baseline gap-1.5">
                  <span className="text-xl sm:text-3xl font-heading font-extrabold text-white">69.5k</span>
                  <span className="text-[10px] sm:text-xs font-bold text-cyan-400 flex items-center gap-0.5">
            ...
            <div className="bg-zinc-900/50 rounded-2xl p-3 sm:p-4 border border-zinc-800/60">
              <div className="flex justify-between items-center mb-2 text-xs">
                <span className="text-zinc-400 font-medium flex items-center gap-1.5 text-[10px] sm:text-xs">
                  <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                  Avg. Viewer Retention
                </span>
                <span className="font-bold text-white bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded-md border border-emerald-500/30 text-[10px] sm:text-xs">
                  27%
                </span>
              </div>
              ...
              <p className="text-[10px] text-zinc-400 mt-2 flex justify-between items-center">
